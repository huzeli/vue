  ...
  <div>
    <div>
      ...
      <el-select v-model="jl.titleLevel"
        ...
        <el-option v-for="item in titileLevels"
                   :key="item"
                   :label="item"
                   :value="item">
        </el-option>
        ...
        <el-table-column prop="enabled"
          ...
          <template slot-scope="scope">
            <el-tag v-if="scope.row.enabled"
                    type="success">已启用</el-tag>
            <el-tag v-else="scope.row.enabled"
    ...
    <el-dialog title="编辑职称"
      ...
      <table>
        ...
        <tr>
          ...
          <td>
            <el-switch style="display: block;margin-left:6px"
      ...
      <span slot="footer"
            class="dialog-footer">
        <el-button size="small"
                   @click="dialogVisible">取 消</el-button>
        <el-button type="primary"
                   size="small"
...
export default {
  ...
  methods: {
    ...
    handleDelete (index, data) {
      this.$confirm('您是否删除[' + data.name + ']职称?', '提示', {
